...
type ASMProxyConfigSpec struct {
	...
	SidecarProxyInitResource *corev1.ResourceRequirements `protobuf:"bytes,5,opt,name=sidecarProxyInitResource,proto3"   json:"sidecarProxyInitResource,omitempty" yaml:"sidecarProxyInitResource"`
	SidecarProxyResource     *corev1.ResourceRequirements `protobuf:"bytes,6,opt,name=sidecarProxyResource,proto3"   json:"sidecarProxyResource,omitempty" yaml:"sidecarProxyResource"`

	ScaledSidecarResource *ScaledSidecarResource `json:"scaledSidecarResource,omitempty" yaml:"scaledSidecarResource"`
