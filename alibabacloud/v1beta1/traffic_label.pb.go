...
func file_alibabacloud_v1beta1_traffic_label_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_alibabacloud_v1beta1_traffic_label_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_alibabacloud_v1beta1_traffic_label_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_alibabacloud_v1beta1_traffic_label_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_alibabacloud_v1beta1_traffic_label_proto_msgTypes[3].Exporter = func(v any, i int) any {
