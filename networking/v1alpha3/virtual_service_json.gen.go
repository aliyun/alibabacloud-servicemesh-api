...
// MarshalJSON is a custom marshaler for HeaderToSubsetKey
func (this *HeaderToSubsetKey) MarshalJSON() ([]byte, error) {
	str, err := VirtualServiceMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for HeaderToSubsetKey
func (this *HeaderToSubsetKey) UnmarshalJSON(b []byte) error {
	return VirtualServiceUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
