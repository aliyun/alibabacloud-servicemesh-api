...
// DeepCopyInto supports using HeaderToSubsetKey within kubernetes types, where deepcopy-gen is used.
func (in *HeaderToSubsetKey) DeepCopyInto(out *HeaderToSubsetKey) {
	p := proto.Clone(in).(*HeaderToSubsetKey)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HeaderToSubsetKey. Required by controller-gen.
func (in *HeaderToSubsetKey) DeepCopy() *HeaderToSubsetKey {
	if in == nil {
		return nil
	}
	out := new(HeaderToSubsetKey)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new HeaderToSubsetKey. Required by controller-gen.
func (in *HeaderToSubsetKey) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
