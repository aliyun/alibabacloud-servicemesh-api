...
// DeepCopyInto supports using HTTPRouteFallbackTarget within kubernetes types, where deepcopy-gen is used.
func (in *HTTPRouteFallbackTarget) DeepCopyInto(out *HTTPRouteFallbackTarget) {
	p := proto.Clone(in).(*HTTPRouteFallbackTarget)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRouteFallbackTarget. Required by controller-gen.
func (in *HTTPRouteFallbackTarget) DeepCopy() *HTTPRouteFallbackTarget {
	if in == nil {
		return nil
	}
	out := new(HTTPRouteFallbackTarget)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRouteFallbackTarget. Required by controller-gen.
func (in *HTTPRouteFallbackTarget) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
