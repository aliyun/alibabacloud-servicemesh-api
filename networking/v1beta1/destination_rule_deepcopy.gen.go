...
// DeepCopyInto supports using LoadBalancerSettings_LbSubsetConfig within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_LbSubsetConfig) DeepCopyInto(out *LoadBalancerSettings_LbSubsetConfig) {
	p := proto.Clone(in).(*LoadBalancerSettings_LbSubsetConfig)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_LbSubsetConfig. Required by controller-gen.
func (in *LoadBalancerSettings_LbSubsetConfig) DeepCopy() *LoadBalancerSettings_LbSubsetConfig {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_LbSubsetConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_LbSubsetConfig. Required by controller-gen.
func (in *LoadBalancerSettings_LbSubsetConfig) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using LoadBalancerSettings_LbSubsetConfig_SubsetSelector within kubernetes types, where deepcopy-gen is used.
func (in *LoadBalancerSettings_LbSubsetConfig_SubsetSelector) DeepCopyInto(out *LoadBalancerSettings_LbSubsetConfig_SubsetSelector) {
	p := proto.Clone(in).(*LoadBalancerSettings_LbSubsetConfig_SubsetSelector)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_LbSubsetConfig_SubsetSelector. Required by controller-gen.
func (in *LoadBalancerSettings_LbSubsetConfig_SubsetSelector) DeepCopy() *LoadBalancerSettings_LbSubsetConfig_SubsetSelector {
	if in == nil {
		return nil
	}
	out := new(LoadBalancerSettings_LbSubsetConfig_SubsetSelector)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new LoadBalancerSettings_LbSubsetConfig_SubsetSelector. Required by controller-gen.
func (in *LoadBalancerSettings_LbSubsetConfig_SubsetSelector) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
