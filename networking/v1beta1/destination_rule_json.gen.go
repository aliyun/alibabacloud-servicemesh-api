...
// MarshalJSON is a custom marshaler for LoadBalancerSettings_LbSubsetConfig
func (this *LoadBalancerSettings_LbSubsetConfig) MarshalJSON() ([]byte, error) {
	str, err := DestinationRuleMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for LoadBalancerSettings_LbSubsetConfig
func (this *LoadBalancerSettings_LbSubsetConfig) UnmarshalJSON(b []byte) error {
	return DestinationRuleUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}

// MarshalJSON is a custom marshaler for LoadBalancerSettings_LbSubsetConfig_SubsetSelector
func (this *LoadBalancerSettings_LbSubsetConfig_SubsetSelector) MarshalJSON() ([]byte, error) {
	str, err := DestinationRuleMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for LoadBalancerSettings_LbSubsetConfig_SubsetSelector
func (this *LoadBalancerSettings_LbSubsetConfig_SubsetSelector) UnmarshalJSON(b []byte) error {
	return DestinationRuleUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}
